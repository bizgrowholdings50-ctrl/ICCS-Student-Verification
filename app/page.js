      ...
      <main className="flex-grow pt-28">
        ...
        <section className="max-w-4xl mx-auto text-center px-6 mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-[#12066a] mb-6 leading-tight">
            Verify Academic{" "}
            <span className="bg-clip-text text-[#997819]">Credentials</span>
          </h1>
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full w-full flex flex-col items-center pt-16 px-28">
                      ...
                      <div className="text-center mb-4">
                        ...
                        <p className="text-[#b89146] text-[20px] font-bold mt-3">
                          This certificate is proudly awarded to
                        </p>
                        <h2 className="text-5xl text-[#12066a] font-semibold pt-2 pb-6">
                          {studentData.name}
                        </h2>
                      </div>
                      ...
                      <div className="text-center max-w-3xl">
                        <p className="text-[#997819] text-[22px] font-serif font-light">
                          For successfully completing the professional
                          certification program in
                        </p>
                        <h4 className="text-[26px] font-black font-serif text-[#b89146] mt-2 mb-2 uppercase">
                          {studentData.course}
                        </h4>
                        <p className="text-black text-[15px] leading-relaxed font-light px-10">
                          This program is designed to develop practical and
                          strategic expertise in global logistics, procurement,
                      ...
                      <div className="grid grid-cols-4 w-full px-12 mt-auto pb-22 text-center items-end relative">
                        <div className="pb-2 text-left">
                          <p className="text-[10px] font-black text-[#997819]">
                            ISSUED BY:
                          </p>
                          <p className="font-bold text-[#12066a] text-[10px]">
                            ICCS - International College
                          </p>
                        </div>
                        <div className="pb-4 border-l border-black/20 flex flex-col">
                          ...
                          <p className="font-bold text-[#12066a] text-[11px]">
                        ...
                        <div className="pb-4 border-l border-black/20 flex flex-col">
                          ...
                          <p className="font-bold text-[#12066a] text-[11px]">
                            {studentData.certificate_id || studentData.id}
                          </p>
                        </div>
                        <div className="flex justify-end">
                          <div className="bg-white p-2 rounded-lg shadow-sm">
                            <QRCodeSVG
                              ...
                              size={80}
                              marginSize={4} // includeMargin ki jagah ye use karein
                              level={"H"}
                            />
                          </div>
                        </div>
